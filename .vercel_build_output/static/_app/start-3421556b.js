...
import { _ as V } from './chunks/preload-helper-ec9aa979.js';
import { i as D } from './chunks/singletons-12a22614.js';
function C(t) {
	let e, r, s;
	const a = [t[2] || {}];
	var o = t[0][1];
	...
	return {
		...
		p(t, r) {
			t[0][1]
				? s
					? (s.p(t, r), 1 & r && j(s, 1))
					: ((s = C(t)), s.c(), j(s, 1), s.m(e.parentNode, e))
				: s &&
				  (S(),
				  O(s, 1, 1, () => {
						s = null;
...
function G(t) {
	...
	return {
		...
		p(t, s) {
			t[5] ? (r ? r.p(t, s) : ((r = J(t)), r.c(), r.m(e, null))) : r && (r.d(1), (r = null));
		},
		d(t) {
			t && f(e), r && r.d();
		}
...
function M(t) {
	...
	var n = t[0][0];
	function i(t) {
		let e = { $$slots: { default: [F] }, $$scope: { ctx: t } };
	...
	return {
		...
		o(t) {
			e && O(e.$$.fragment, t), (a = !1);
		},
		d(t) {
			e && k(e, t), t && f(r), l && l.d(t), t && f(s);
		}
	};
}
function W(t, e, r) {
	let { stores: s } = e,
		...
		{ props_1: i = null } = e,
		{ props_2: l = null } = e;
	U('__svelte__', s), A(s.page.notify);
	let c = !1,
		u = !1,
		h = null;
	return (
...
const X = [
		() =>
			V(
				() => import('./pages/__layout.svelte-fd16e585.js'),
				[
					'pages/__layout.svelte-fd16e585.js',
					'assets/pages/__layout.svelte-a2c21bdf.css',
					'chunks/vendor-4465f8c9.js',
					'chunks/preload-helper-ec9aa979.js'
				]
			),
		() =>
			V(
				() => import('./error.svelte-512510d9.js'),
				['error.svelte-512510d9.js', 'chunks/vendor-4465f8c9.js']
			),
		() =>
			V(
				() => import('./pages/index.svelte-6abac41a.js'),
				[
					'pages/index.svelte-6abac41a.js',
					'assets/pages/index.svelte-f8c26d9a.css',
					'chunks/vendor-4465f8c9.js',
					'chunks/navigation-51f4a605.js',
					'chunks/singletons-12a22614.js',
					'chunks/_SetLanguage-5b0c250f.js',
					'chunks/_TextBox-13ab11d7.js'
				]
			),
		() =>
			V(
				() => import('./pages/FindPatient.svelte-ab9d35cb.js'),
				[
					'pages/FindPatient.svelte-ab9d35cb.js',
					'chunks/vendor-4465f8c9.js',
					'chunks/_Navigation-c30c9703.js',
					'chunks/_SetLanguage-5b0c250f.js',
					'chunks/_SearchUser-8a75a77d.js',
					'chunks/_Button-bc959185.js',
					'chunks/_ButtonGreen-75f1b9e2.js',
					'chunks/navigation-51f4a605.js',
					'chunks/singletons-12a22614.js'
				]
			),
		() =>
			V(
				() => import('./pages/NewPatient.svelte-e1b31a23.js'),
				[
					'pages/NewPatient.svelte-e1b31a23.js',
					'chunks/vendor-4465f8c9.js',
					'chunks/_Navigation-c30c9703.js',
					'chunks/_SetLanguage-5b0c250f.js',
					'chunks/_Button-bc959185.js',
		...
		() =>
			V(
				() => import('./pages/patient/[id].svelte-fe073c65.js'),
				[
					'pages/patient/[id].svelte-fe073c65.js',
					'chunks/vendor-4465f8c9.js',
					'chunks/_Navigation-c30c9703.js',
					'chunks/_SetLanguage-5b0c250f.js',
					'chunks/_ButtonGreen-75f1b9e2.js'
		...
		() =>
			V(
				() => import('./pages/home.svelte-16a1b5ed.js'),
				[
					'pages/home.svelte-16a1b5ed.js',
					'chunks/vendor-4465f8c9.js',
					'chunks/_Navigation-c30c9703.js',
					'chunks/_SetLanguage-5b0c250f.js',
					'chunks/_SearchUser-8a75a77d.js',
	...
	H = [
		[/^\/$/, [X[0], X[2]], [X[1]]],
		[/^\/postalCodeInfo\/?$/],
		[/^\/FindPatient\/?$/, [X[0], X[3]], [X[1]]],
		[/^\/NewPatient\/?$/, [X[0], X[4]], [X[1]]],
		[/^\/patient\/([^/]+?)\/?$/, [X[0], X[5]], [X[1]], (t) => ({ id: Y(t[1]) })],
		[/^\/login\/?$/],
		[/^\/home\/?$/, [X[0], X[6]], [X[1]]]
	],
	Q = [X[0](), X[1]()];
...
class st {
	...
	init_listeners() {
		...
		const s = (t) => {
			const e = et(t.target);
			e && e.href && e.hasAttribute('sveltekit:prefetch') && this.prefetch(rt(e));
		};
		let a;
	...
	async goto(
		...
		return this.enabled && this.owns(n)
			? (history[r ? 'replaceState' : 'pushState'](a, '', t),
			  this._navigate(n, e ? tt() : null, s, o, n.hash))
...
function at(t) {
	return t instanceof Error || (t && t.name && t.message) ? t : new Error(JSON.stringify(t));
}
function ot(t) {
	const e = N(t);
	let r = !0;
...
class it {
	...
	async start({ status: t, error: e, nodes: r, page: s }) {
		...
		try {
			for (let o = 0; o < r.length; o += 1) {
				...
				if ((a.push(u), u && u.loaded))
					if (u.loaded.error) {
						...
						n = { status: u.loaded.status, error: u.loaded.error, path: s.path, query: s.query };
			...
			if (e) throw c;
			o = await this._load_error({ status: 500, error: at(c), path: s.path, query: s.query });
		}
			...
			const { started: c } = this,
				u = {
					...
					fetch(t, e) {
						...
						return o.uses.dependencies.push(a), c ? fetch(t, e) : nt(t, e);
					}
				};
	...
	async _load({ route: t, info: { path: e, decoded_path: r, query: s } }, a) {
		...
		const [n, l, c, u] = t,
			...
			d = this.current.page && {
				...
				params: Object.keys(h).filter((t) => this.current.page.params[t] !== h[t]),
		...
		t: for (let v = 0; v < l.length; v += 1) {
			...
			try {
				...
				if (
					...
					if (t && t.loaded) {
						if (
							(t.loaded.error && ((y = t.loaded.status), (f = t.loaded.error)), t.loaded.redirect)
						)
			...
			if (f) {
				...
				return await this._load_error({ status: y, error: f, path: e, query: s });
			}
			t && t.loaded && t.loaded.context && (m = i(i({}, m), t.loaded.context)), g.push(t);
		}
		return await this._get_navigation_result_from_branch({ page: p, branch: g });
	}
...
async function lt({
	...
	const l = new it({ Root: z, fallback: Q, target: e, session: r, host: s }),
		c = a ? new st({ base: t.base, routes: H, trailing_slash: n, renderer: l }) : null;
	D(c),
		(function (t) {
			(Z = t.base), t.assets;
		})(t),
		i && (await l.start(i)),
		c && (o && c.goto(location.href, { replaceState: !0 }, []), c.init_listeners()),
